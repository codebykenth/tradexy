<x-layouts.app title="Log In - Tradexy">
        ...
        <div class="flex flex-col lg:flex-row h-[calc(100vh-100px)] w-full">
            ...
            <div class="hidden lg:flex w-1/2 relative bg-gray-900 rounded-2xl overflow-hidden my-4 mr-0">
                ...
                <div class="absolute bottom-0 left-0 p-12 text-white z-10">
                    <blockquote class="text-2xl font-medium mb-4 leading-relaxed">"The goal of a successful trader is to
                        make the best trades. Money is secondary."</blockquote>
                    <cite class="not-italic opacity-80 font-normal">— Alexander Elder</cite>
                </div>
            </div>
                ...
                <div class="w-full max-w-md space-y-8">
                    <div class="text-center lg:text-left">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Don't have an account? <a href="{{ route('register') }}"
                                class="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">Sign up for
                                free</a>
                        </p>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="bg-[#FDFDFC] dark:bg-[#0a0a0a] px-2 text-gray-500">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <form action="/login" method="post" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    <a href="{{ route('forgot-password') }}"
                                        class="font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Forgot
                                        password?</a>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember_me" name="remember_me" type="checkbox" value="1" {{ old('remember_me') ? 'checked' : '' }}
