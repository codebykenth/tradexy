<x-layouts.app title="Tradexy">
    ...
    <main class="w-full">
        ...
        <!-- Features -->
        <section id="features" class="py-24 bg-gray-50 dark:bg-[#0F0F0E] border-y border-gray-200 dark:border-[#1F1F1E] scroll-mt-32">
        ...
        <!-- How it Works (Loop) -->
        <section id="how-it-works" class="py-24 max-w-7xl mx-auto px-6 scroll-mt-32">
        ...
        <!-- Why Tradexy -->
        <section id="why-tradexy" class="py-24 bg-gray-50 dark:bg-[#0F0F0E] border-y border-gray-200 dark:border-[#1F1F1E] scroll-mt-32">
            <div class="max-w-7xl mx-auto px-6">
